...
usage -auto -elapse
set log file fv/DNSLookup/rtl_to_g1.log -replace
tclmode
...
add search path -library /CMC/kits/GPDK45/gsclib045_all_v4.4/gsclib045/timing
...
elaborate design -golden -root DNSLookup -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/DNSLookup/g1.v.gz
} else {
...
elaborate design -revised -root DNSLookup
